...
namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("Learn how to process modern material into new alloys and new types of resources! Level by refining advanced Materials and crafting related recipes."); } }
    ...
    public partial class MaterialProcessorSkillBookRecipe : RecipeFamily
    {
        public MaterialProcessorSkillBookRecipe()
        {
            ...
            recipe.Init(
                "Material Processor",  //noloc
                Localizer.DoStr("Material Processor Skill Book"),
